...
namespace MainProgram
{
    public class Program
    {
        public class Characters
        {
            ...
            public Characters(string _name, int _hp, int _defense, string _weapon, string _armour, double _damage, int _priority, int _points, Hero? _eredeti, int _level, bool _canFly)
            {
                name = _name;
                hp = _hp;
                defense = _defense;
        ...
        public class Enemy : Characters
        {
            ...
            public Enemy(string _name, int _hp, int _defense, string _weapon, string _armour, double _damage, int _priority, int _points,
            Hero? _eredeti, int _level, bool _canFly) : base(_name, _hp, _defense, _weapon, _armour, _damage, _priority,_points, _eredeti, _level, _canFly)
            {
        ...
        {
            public Hero(string _name, int _hp, int _defense, string _weapon, string _armour, double _damage, int _priority, int _points,
            Hero? _eredeti, int _level, bool _canFly) : base(_name, _hp, _defense, _weapon, _armour, _damage, _priority, _points, _eredeti, _level, _canFly)
            {
        ...
        public static Hero? createCharacter(int classnumber = 0)
        {
            ...
            hero.eredeti = new Hero(hero.name, hero.hp, hero.defense, hero.weapon, hero.armour, hero.damage, hero.points, hero.priority, null, 1, false);
        ...
        public static Enemy createEnemy(int miniBossInt, bool externalCondition) {
            ...
            switch (rnd) {
                case 1:
                    enemy = new Enemy("Goblin", 25, 20, "nincs", "nincs", 100, 10, 10, null, 1, false);
                    break;
                case 2:
                    enemy = new Enemy("Giant Rat", 20, 50, "nincs", "nincs", 20, 7, 10, null, 1, false);
                    break;
                case 3:
                    enemy = new Enemy("Giant Spider", 20, 80, "nincs", "nincs", 30, 7, 10, null, 1, false);
                    break;
                case 4:
                    enemy = new Enemy("Skeleton", 50, 90, "nincs", "nincs", 70, 8, 10, null, 1, false);
                    break;
                case 5:
                    enemy = new Enemy("Werewolf", 100, 95, "nincs", "nincs", 90, 12, 10, null, 1, false);
                    break;
                case 6:
                    enemy = new Enemy("Orc", 120, 130, "nincs", "nincs", 140, 11, 10, null, 1, false);
                    break;
                case 7:
                    enemy = new Enemy("Demon", 140, 100, "nincs", "nincs", 120, 13, 10, null, 1, true);
                    break;
            }
            return enemy;
        }
        ...
        public static Enemy miniBoss()
        {
            ...
            Enemy? motherSpider = createEnemy(miniBossInt, externalCondition);
